...
<html>
	...
	<body>
					...
					<table width='100%'>
						<tr>
							<td align="center">
								<a href="${baseurl}/user/listbagitem?uid=${uid}&goodsId=${goodsId}&serverId=${serverId}" style="border:1px solid #000; width:5%;display:block ;text-align:center;background-color: #97a5b0">确认</a>
							</td>
						</tr>
					</table>
	</body>
