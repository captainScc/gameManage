...
<script lang="text/javascript">
	...
	function importypxxsubmit(){
		jquerySubByFId("importypxxForm",importypxxsubmit_callback);
	}
	function importypxxsubmit_callback(data){
		_alert(data);		//基本信息 + 错误提示信息
	}
</script>

</head>
<body>
<form id="importypxxForm"  action="${baseurl}/ypml/importypxx_submit.action" method="post" enctype="multipart/form-data">
						...
						<TBODY>
							...
							<TR>
								...
								<TD colspan=2  align=center class=category>
									<a id="submitbtn" href="#" class="easyui-linkbutton" data-options="iconCls: 'icon-ok'" onclick="importypxxsubmit()">导入</a>
