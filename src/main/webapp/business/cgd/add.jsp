...
//提交采购单
function yycgdsave(){
	jquerySubByFId("yycgdform" , yycgdsave_callback);
}
function yycgdsave_callback(data){
	message_alert(data,yycgdsave_message_callback);
}
function yycgdsave_message_callback(sysdata){
	
	
	//直接使用js修改页面路径
	location.href = "${baseurl}/cgd/edit.action?yycgdCustom.id=" + sysdata.yycgdId;
}
...
<body>
<form id="yycgdform" action="${baseurl }/cgd/add_submit.action" method="post">
<!-- 添加采购单表格 -->
					...
					<TABLE class="toptable grid" border=1 cellSpacing=1 cellPadding=4
						...
						<TBODY>
							<TR>
								...
								<TD class=category width="35%">
								<div>
								<input type="text" id="yycgd_id" name="yycgdCustom.mc" readonly="readonly" value="${yycgdCustom.mc}" style="width:260px" />
								</div>
